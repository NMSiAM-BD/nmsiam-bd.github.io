        ...
        function updateCurrentGPA() {
            ...
            rows.forEach(row => {
                ...
                if (creditInput.value.trim() !== '' && gradePointInput.value.trim() !== '' && 
                    !isNaN(credit) && !isNaN(gradePoint) && credit > 0 && gradePoint >= 0) {
                    totalCredits += credit;
        ...
        function createCourseRow(courseNumber) {
            ...
            row.innerHTML = `
                ...
                <td>
                    <input type="number" class="grade-point-input grade-point" 
                           placeholder="4.00" 
                           min="0.0" max="4.0" step="0.01">
                </td>
        ...
        function loadStudentInfo() {
            ...
            if (saved) {
                try {
                    ...
                    document.getElementById('universityName').value = studentInfo.universityName || '';
        ...
        function getResultData(studentInfo = {}) {
            ...
            rows.forEach((row, index) => {
                ...
                // Get grade point value - if empty or invalid, show N/A
                const gradePointValue = gradePointInput.value.trim();
                const gradePoint = gradePointValue === '' ? 'N/A' : (isNaN(parseFloat(gradePointValue)) ? 'N/A' : parseFloat(gradePointValue).toFixed(2));
        ...
        function generateFileName(studentInfo, data) {
            ...
            if (name && id) {
                return `CGPA_Result_${name}_${id}_${dateStr}`;
            } else {
                return `CGPA_Result_${dateStr}`;
            }
        }
        ...
        function exportToPDF(studentInfo) {
            ...
            // University Name - Use from studentInfo or default
            doc.setFontSize(14);
            doc.setTextColor(75, 108, 183);
            doc.text(data.studentInfo.universityName || "Independent University, Bangladesh", doc.internal.pageSize.width / 2, yPos, { align: 'center' });
            yPos += 15;
            ...
            const tableConfig = {
                startY: yPos,
                head: [['Course Name', 'Credit', 'Grade Point']],
                body: tableData,
                theme: 'striped',
            ...
            for (let i = 1; i <= totalPages; i++) {
                ...
                doc.setFontSize(9);
                doc.setTextColor(127, 140, 141);
                const generatorText = "Generated by: CGPA Calculator - N M SiAM, Developed by Noor Mohammad Siam";
        ...
        function exportToCSV(studentInfo) {
            ...
            csvContent += `${data.studentInfo.universityName || "Independent University, Bangladesh"}\n\n`;
            ...
            csvContent += "Courses\n";
            csvContent += "Course Name,Credit,Grade Point\n";
            
            data.courses.forEach(course => {
                csvContent += `${course.name},${course.credit},${course.gradePoint}\n`;
            });
            
            // Add footer section
            csvContent += "\n";
            csvContent += "Note: This is an unofficial result. Refer to your official transcript for official CGPA.\n";
            csvContent += "Generated by: CGPA Calculator - N M SiAM, Developed by Noor Mohammad Siam\n";
        ...
        function exportToText(studentInfo) {
            ...
            textContent += `${data.studentInfo.universityName || "Independent University, Bangladesh"}\n`;
            ...
            data.courses.forEach((course, index) => {
                ...
                textContent += `   Credit: ${course.credit} | Grade Point: ${course.gradePoint}\n`;
            });
            
            textContent += "\n" + "=".repeat(60) + "\n";
            textContent += "Note: This is an unofficial result. Refer to your official transcript for official CGPA.\n";
            textContent += "Generated by: CGPA Calculator - N M SiAM, Developed by Noor Mohammad Siam\n";
        ...
        function printResult(studentInfo) {
            ...
            let printContent = `
                ...
                <body>
                    <div class="header">
                        <h1>CGPA Result</h1>
                        <div class="university">${data.studentInfo.universityName || "Independent University, Bangladesh"}</div>
            ...
            printContent += `
                    ...
                    <div class="footer">
                        <p>Generated by: CGPA Calculator - N M SiAM, Developed by Noor Mohammad Siam</p>
